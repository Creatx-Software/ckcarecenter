        ...
        <div class="section pt-0 " style="margin-top: 5rem;">
            <div class="r-container d-flex flex-column gap-4">
                ...
                <div class="row row-cols-xl-2 row-cols-1">
                    ...
                    <div class="col col-xl-7 mb-3 scrollanimation animated fadeInRight d-flex flex-column">
                        ...
                        {{-- Learn More button below image on mobile only --}}
                        <div class="d-flex justify-content-end mt-3 d-xl-none">
                            <a href="{{ route('contact') }}"
                                class="btn btn-about-learn rounded-pill px-4 py-2">
                                Learn More
                            </a>
                        </div>
                    </div>
